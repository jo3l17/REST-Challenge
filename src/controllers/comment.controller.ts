...
const createComment = async (req: Request, res: Response) => {
  const comment = await CommentService.create(req.body.user.accountId, parseInt(req.params.postId), req.body);
...
const getActionOfComment = async (req: Request, res: Response) => {
    const action = await CommentService.recountAction(parseInt(req.params.commentId), req.params.action)
...
export {createComment, getComment, updateComment, deleteComment, getAllComments, getActionOfComment, giveActionToComment};