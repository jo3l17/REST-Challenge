...
import { createPost, deletePost, getActionsOfPost, getAllPosts, getCommentsOfPost, getPost, getPostList, giveActionToPost, updatePost } from "../controllers/post.controller";
